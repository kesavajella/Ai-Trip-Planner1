...
public class TripApiController {
    ...
    public TripApiController(ItineraryGeneratorService itineraryGenerator, TripService tripService, NotificationService notificationService, UserRepository userRepository) {
